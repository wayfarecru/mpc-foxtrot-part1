...
int main(int argc, const char* argv[]) {
	...
	kernel_vec_add <<< dimGrid, dimBlock>>>(devPtrC, devPtrA, devPtrB, N);
...
// HISTORY: vec-add-big.cu <-- rand-vec-add.cu <-- chrono-vec-add.cu <-- vec-add.cu
static const char rcsid[] __attribute__((used)) = "$Id: 04a-vec-add-big.cu,v 1.4 2026/08/29 02:48:34 wayfarecru Exp $";
