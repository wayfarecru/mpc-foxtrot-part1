...
// HISTORY: axpy.cu <-- vec-add-big.cu <-- rand-vec-add.cu <-- chrono-vec-add.cu <-- vec-add.cu
static const char rcsid[] __attribute__((used)) = "$Id: 04d-axpy.cu,v 1.4 2026/08/29 02:48:37 wayfarecru Exp $";
