...
// HISTORY: lerp-fma.cu <-- axpy-fma.cu <-- axpy.cu <-- vec-add-big.cu <-- rand-vec-add.cu <-- chrono-vec-add.cu <-- vec-add.cu
static const char rcsid[] __attribute__((used)) = "$Id: 04g-lerp-fma.cu,v 1.4 2026/08/29 02:48:39 wayfarecru Exp $";
